...
export const displayComponentMeta = [
  { component: ClassComponentWithState, description: 'Class with state', keyName: 'comp1' },
  { component: PureClassComponentWithState, description: 'Pure class with state', keyName: 'comp2' },
  { component: ClassComponentWithShouldUpdate, description: 'Class with should update', keyName: 'comp3' },
  { component: FunctionComponent, description: 'Function without state', keyName: 'comp4' },
  { component: MemoFunctionComponent, description: 'Memo function without state', keyName: 'comp5' }
];

export const displayComponentWithPropsMeta = [
  { component: ClassComponentWithStateAndProps, description: 'Class with state and props', keyName: 'comp11' },
  { component: PureClassComponentWithProps, description: 'Pure class with props', keyName: 'comp12' },
  { component: ClassComponentWithPropsAndShouldUpdate, description: 'Class with props and shouldUpdate', keyName: 'comp13' },
  { component: ClassComponentWithPropsAndShouldUpdateAndChildren, description: 'Class with state props and children', keyName: 'comp14' },
